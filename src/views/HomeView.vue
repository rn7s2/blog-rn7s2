    ...
    <div class="mx-lg-12" v-if="isPostsOverviewLoaded">
      <div class="mx-sm-16 mx-lg-16 px-lg-16">
        ...
        <div class="mx-md-14 px-md-14">
          <v-card class="mt-5" v-for="postOverview in postsOverview" :key="postOverview.id"
            ...
            <v-card-text class="mx-6" v-html="this.markdown(postOverview.abstract)"></v-card-text>
            <v-card-actions>
